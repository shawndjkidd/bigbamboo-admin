...
export default function JukeboxLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      <link
        rel="stylesheet"
        href="https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;600;700&family=Bebas+Neue&family=Sigmar&family=JetBrains+Mono:wght@400;500&display=swap"
      />
