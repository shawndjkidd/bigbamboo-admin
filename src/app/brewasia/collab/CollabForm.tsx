...
const T = {
  en: {
    ...
    deliverText: '10 An Phú, An Khánh, Ho Chi Minh City. Weekdays only, by Friday 23 October, so we can build the Ale Trail maps.',
  ...
  vi: {
    ...
    deliverText: '10 An Phú, An Khánh, TP. Hồ Chí Minh. Chỉ ngày thường, trước Thứ Sáu 23/10, để chúng tôi làm bản đồ Ale Trail.',
