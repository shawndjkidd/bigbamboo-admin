...
const btn = { padding: '9px 14px', background: 'var(--accent, #e87830)', color: 'var(--accent-contrast, #fff)', border: 'none', borderRadius: 8, fontSize: 14, fontWeight: 600, cursor: 'pointer', whiteSpace: 'nowrap' as const }
...
const tabActive = { background: 'var(--accent,#e87830)', color: 'var(--accent-contrast, #fff)', borderColor: 'var(--accent,#e87830)' }
