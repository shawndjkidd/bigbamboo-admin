...
// ─── Prize Configuration ───
const PRIZES = [
  { id: "free-cocktail", label: "Free Signature Cocktail", emoji: "\u{1F379}", tier: "big", weight: 5 },
  { id: "free-beer", label: "Free Craft Beer", emoji: "\u{1F37A}", tier: "big", weight: 5 },
  { id: "free-appetizer", label: "Free Appetizer", emoji: "\u{1F960}", tier: "medium", weight: 12 },
  { id: "bogo-cocktail", label: "Buy 1 Get 1 Cocktail", emoji: "\u{1F378}", tier: "medium", weight: 15 },
  { id: "bogo-beer", label: "Buy 1 Get 1 Beer", emoji: "\u{1F37B}", tier: "medium", weight: 13 },
  { id: "20-off", label: "20% Off Your Bill", emoji: "\u{1F4B0}", tier: "small", weight: 20 },
  { id: "10-off", label: "10% Off Your Bill", emoji: "\u{1F389}", tier: "small", weight: 30 },
];
...
function TropicalBG() {
  return (
    <div style={{ position: "absolute", inset: 0, overflow: "hidden", pointerEvents: "none" }}>
      ...
      {/* Palm leaf silhouettes — top left */}
      ...
      {/* Palm leaf silhouettes — top right */}
...
// ─── Premium Coconut ───
function CoconutSVG({ crackStage, shaking, tapFlash }) {
  ...
  return (
    <div style={{ position: "relative", width: 230, height: 230 }}>
      ...
      {/* Golden inner glow (through cracks) */}
      <div style={{
        ...
        <div style={{
          ...
          <svg viewBox="0 0 230 230" width="230" height="230">
            ...
            <g clipPath={crackStage >= 3 ? "url(#lClip)" : undefined}>
              ...
              {/* Crack stage 2 — branches + golden glow */}
              {crackStage >= 2 && (
                <g style={{ animation: "crackAppear 0.25s ease-out" }}>
...
// ─── Prize Card ───
function PrizeCard({ prize, onAddToWallet, onPlayAgain }) {
  ...
  if (!prize) {
    return (
      <div style={{ textAlign: "center", opacity: show ? 1 : 0, transform: show ? "translateY(0) scale(1)" : "translateY(30px) scale(0.9)", transition: "all 0.6s cubic-bezier(0.34,1.56,0.64,1)" }}>
        ...
        <div style={{ ...F.display, fontSize: 30, color: B.cream, marginBottom: 8 }}>Empty Coconut!</div>
        <div style={{ ...F.body, color: B.creamSoft, marginBottom: 28 }}>This one was dry — try again next time</div>
        <button onClick={onPlayAgain} style={S.btnGhost}>Crack Another</button>
      </div>
    );
  }
  ...
  return (
    <div style={{ textAlign: "center", opacity: show ? 1 : 0, transform: show ? "translateY(0) scale(1)" : "translateY(30px) scale(0.9)", transition: "all 0.6s cubic-bezier(0.34,1.56,0.64,1)", maxWidth: 330 }}>
      ...
      <button onClick={onPlayAgain} style={{ ...S.btnGhost, marginTop: 22 }}>Crack Another</button>
    </div>
  );
}

// ─── Wallet Modal ───
function WalletModal({ prize, onClose }) {
    ...
    <div style={{ position: "fixed", inset: 0, background: "rgba(8,18,16,0.82)", backdropFilter: "blur(14px)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 100, padding: 20 }} onClick={(e) => e.target === e.currentTarget && onClose()}>
      <div style={{
        ...
        {step === "done" && (<>
          ...
          <div style={{ background: `${B.cream}06`, borderRadius: 14, padding: "16px 18px", marginBottom: 24, textAlign: "left" }}>
    ...
    <div style={{
      ...
      <div style={{ position: "relative", zIndex: 10, flex: 1, display: "flex", flexDirection: "column", alignItems: "center", padding: "36px 20px 24px", maxWidth: 420, margin: "0 auto", width: "100%" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 16 }}>
          ...
          <div style={{ ...F.display, fontSize: 14, color: B.creamMuted, letterSpacing: "0.22em" }}>COCONUT CRACKER</div>
        </div>
        ...
        <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", minHeight: 300, width: "100%", cursor: gameState !== "reveal" ? "pointer" : "default", position: "relative" }}
          ...
          {gameState !== "reveal" ? (
            ...
            <div style={{ animation: "fadeInUp 0.5s ease-out" }}>
              <PrizeCard prize={currentPrize} onAddToWallet={() => setShowWalletModal(true)} onPlayAgain={resetGame} />
            </div>
          )}
        </div>
        ...
        {gameState !== "reveal" && (
          <div style={{ textAlign: "center", marginTop: 14 }}>
            <div style={{ ...F.body, fontSize: 15, fontWeight: 500, color: B.creamSoft, animation: tapCount === 0 ? "pulse 2.5s ease-in-out infinite" : "none" }}>
              {crackStage === 0 && "Tap the coconut to crack it"}
...
// ─── Font Shortcuts ───
const F = {
  display: { fontFamily: "'Bebas Neue', sans-serif", letterSpacing: "0.04em", lineHeight: 1.1 },
  body: { fontFamily: "'DM Sans', sans-serif" },
  label: { fontFamily: "'DM Sans', sans-serif", fontWeight: 600, letterSpacing: "0.1em", textTransform: "uppercase" },
};
