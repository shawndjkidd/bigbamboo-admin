...
export async function GET(req: NextRequest) {
  ...
  if (error) {
    console.error('[branding/posters GET]', error.message);
...
export async function POST(req: NextRequest) {
  ...
  if (uploadErr) {
    console.error('[branding/posters POST] storage upload error:', uploadErr.message);
    return NextResponse.json(
  ...
  if (insertErr) {
    ...
    console.error('[branding/posters POST] db insert error:', insertErr.message);
    return NextResponse.json(
